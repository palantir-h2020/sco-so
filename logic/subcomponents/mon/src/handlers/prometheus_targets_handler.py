...
# from db.models.prometheus_targets import PrometheusTargets
from common.db.models.prometheus_targets_operation import\
    PrometheusTargetsOperation
# from db.models.prometheus_targets_operation import\
#     PrometheusTargetsOperation
...
class PrometheusTargetsHandler(object):
    ...
    def __init__(self, targets_file_name: str):
        ...
        # TODO: fix this line, then remove the two below it
        # self.mongo_conn = MongoConnector().db_conn
        disconnect()
    ...
    def _construct_target_model_list_targets(
        ...
        # TODO: investigate why it complains about a weakref
        # db_targets = self._get_targets_from_db()
        # At this point the db_targets list should have been
        # validate to be in a proper state to operate with
        if operation == "add":
            # TODO: investigate why it indicates there is a
            # "weakly-referenced object no longer exists" when
            # adding a new target
